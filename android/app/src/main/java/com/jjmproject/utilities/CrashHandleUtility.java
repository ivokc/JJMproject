...
import com.jjmproject.vendors.crash.RNCrashHandler;
...
import static com.jjmproject.constants.Constant.CRASH_REPORTER_PATH;
 ...
 * date: 2018/1/11
 * desc: 注意！！！崩溃处理现在不完整，后续再根据各项目组需求修改。
 */

public class CrashHandleUtility extends RNCrashHandler implements Thread.UncaughtExceptionHandler {
     ...
     */
    public static final boolean DEBUG = Constant.IS_DEBUG;
     ...
     * CrashHandler实例
     */
    private static CrashHandleUtility INSTANCE;
    /**
     * 程序的Context对象
     */
     ...
     */
    private CrashHandleUtility() {
    }

    /**
     * 获取CrashHandler实例, 单例模式
     */
    public static CrashHandleUtility getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new CrashHandleUtility();
        }
        return INSTANCE;
    }
...
//        sendCrashReportsToServer(mContext);
    ...
    private String saveCrashInfoToFile(Throwable exception) {
        ...
        try {
            ...
            File f = new File(CRASH_REPORTER_PATH + name + CRASH_REPORTER_EXTENSION);
