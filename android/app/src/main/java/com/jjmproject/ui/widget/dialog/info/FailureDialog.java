...
public class FailureDialog extends Dialog {
    ...
    public FailureDialog setupButtonsAttrs(String positiveTitle, String negativeTitle, View.OnClickListener positiveListener, View.OnClickListener negativeListener) {
